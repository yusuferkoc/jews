const expulsionEvents = [
    {
        ...
        reasons: ["Asur İmparatorluğu'nun fethettiği halkları asimile etme stratejisi","İsrail Krallığı'nın siyasi varlığını yok etme amacı"],
    ...
    },
    {
        ...
        reasons: ["Kudüs isyanlarını kökünden kazıma politikası","Siyasi liderler ve teolojik elitlerin sürülerek otoritenin kırılması"],
        category: "Antik Dönem"
    },
    {
        id: "roman_70",
        ...
        reasons: ["Roma İmparatorluğu'na karşı tekrarlanan büyük isyanlar (Örn: Bar Kohba)","Kudüs'ün isyankar bir merkez olmasını tamamen engelleme ve radikal demografik değişim"],
        category: "Antik Dönem"
    },
    {
        id: "england_1290",
        ...
        reasons: ["Kral I. Edward'ın savaş borçlarından kurtulmak için varlıklara el koyması","Toplumda giderek tırmanan 'kan iftiraları' (blood libel) ve dini düşmanlık"],
        category: "Orta Çağ"
    },
    {
        id: "france_1306",
        ...
        reasons: ["Kral IV. Philip'in ekonomik darboğazı aşmak için fon arayışı","Devlet hazinesini, sürülenlerin el konulan nakitleri üzerinden finanse etme stratejisi"],
        category: "Orta Çağ"
    },
    {
        id: "spain_1492",
        ...
        reasons: ["'Saf Kan' (Limpieza de sangre) ve homojen Katolik bir İspanya yaratma arzusu","İspanyol Engizisyonu'nun dini temizlik ve sapkınlık(heretik) algısı"],
        category: "Orta Çağ"
    },
    {
        id: "portugal_1497",
        ...
        reasons: ["İspanya krallığı ile yapılan siyasi ittifakın ve evliliğin değişmez ön şartı","Mal varlıklarının ülke dışına çıkmasını önlemek için kovmak yerine 'zorunlu vaftiz' uygulaması"],
        category: "Orta Çağ"
    },
    {
        id: "russian_pogroms",
        ...
        reasons: ["Çar II. Alexander suikastinde Yahudilerin asılsız yere günah keçisi ilan edilmesi","Toplumsal ve ekonomik buhranların devlet destekli şiddete (pogromlara) kanalize edilmesi"],
    ...
    },
    {
        ...
        reasons: ["Nazi Almanyası'nın Ari ırk ideolojisi","Endüstriyel imha (Soykırım) politikası ile Avrupa'dan varlığın tamamen silinmek istenmesi"],
        category: "Modern Dönem"
    },
    {
        id: "arab_exodus",
        ...
        reasons: ["1948'de İsrail Devleti'nin kurulması ve Arap-İsrail savaşlarının yarattığı gerilim","Kuzey Afrika ve Orta Doğu'da yükselen Arap milliyetçiliğiyle birlikte gelen misilleme/el koyma politikaları"],
        category: "Modern Dönem"
    }
];
...
const sabetayFamilies = [
    ...
    { id: "evliyazadeler", name: "Evliyazadeler", category: "tarih", origin: "Sefarad", coords: [38.4237, 27.1428], description: "Osmanlı döneminin en güçlü Sabetayist ailelerinden biri. Selanik kökenli olup bürokrasi ve ticarette çok etkindi. Evliyazade Naciye, İsmet İnönü ile evlenerek aileyi Cumhuriyet'in kurucu kadrosuna bağlamıştır. Latife Hanım'ın ailesi Uşşakizadeler ile de akrabalık bağları bulunur. Aynizadeler, Ertegün ailesi ve Dinçkök ailesiyle de geniş bir ilişki ağına sahiptir.", members: ["Evliyazade Mehmet Efendi", "Evliyazade Naciye", "Adnan Menderes (damat)"] },
    { id: "inegolluzadeler", name: "İnegöllüzadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı ve erken Cumhuriyet döneminin köklü Sabetayist ailesi. Devlet bürokrasisi, sanat ve iş dünyasında geniş akrabalık ağına sahip.", members: ["Ahmet Tevfik Paşa (Son Sadrazam)", "Selahattin Beyazıt"] },
    { id: "manyasizadeler", name: "Manyasizadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Kapancı cemaatine mensup köklü aile. Osmanlı bürokrasisinde ve sonraki dönemde edebiyat ve sanatta etkili isimler yetiştirdi.", members: ["Manyasizade Refik Bey", "Ahmet Zühtü Paşa"] },
    { id: "kapanci", name: "Kapancı Cemaati", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sabetay Sevi'nin ölümünden sonra oluşan üç büyük dönme cemaatten biri. Jacob Querido'nun takipçileri olarak da bilinir. Selanik'te 'Kapancı' (tüccar) lakabıyla anılmışlar, İstanbul'a göçle birlikte iş dünyası, bürokrasi ve sanatta geniş bir akrabalık ağı kurmuşlardır. Mardinizadeler, Edin, Bezmen, Menemencioğlu, Çapanzadeler, Bayındırlızadeler gibi aileler bu cemaate mensuptur. Nevzat Tandoğan, Kadir Has, Erol Simavi, Suat Hayri Ürgüplü, Halil Rıfat Paşa gibi isimlerle bağlantılıdır.", members: ["Kapancıbaşı ailesi"] },
    { id: "yakubi", name: "Yakubi Cemaati", category: "tarih", origin: "Sefarad", coords: [38.4237, 27.1428], description: "Sabetay Sevi'nin kayınpederi Yosef Filozof'un takipçilerinden oluşan en muhafazakâr dönme cemaati. 'Yakubi' adı Yakup'tan gelir. Selanik'te kendi okulları, sinagogları ve mezarlıkları vardı. Muallim Şemsi Efendi bu cemaatin eğitim öncüsüdür ve Atatürk'ün ilk öğretmeni olarak bilinir. Nuri Conker, Salih Bozok gibi Atatürk'ün Selanikli çevresi bu cemaatle ilişkilendirilir. Evliyazadeler ve Voskay ailesi de Yakubi cemaatiyle bağlantılıdır.", members: ["Yakubi ailesi"] },
    { id: "mardinizadeler", name: "Mardinizadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Kapancı cemaatine mensup tarihi aile. İzzet Mehmet Paşa ile olan bağlantıları bilinen önemli bir Osmanlı ailesidir.", members: ["Mardinizade ailesi üyeleri"] },
    { id: "katipzadeler", name: "Katipzadeler", category: "tarih", origin: "Sefarad", coords: [38.4237, 27.1428], description: "Sabetayist cemaatlerle akrabalık bağları bulunan Osmanlı dönemi ailesi.", members: ["Katipzade ailesi üyeleri"] },
    { id: "keçecizadeler", name: "Keçecizadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı bürokrasisinde ve edebiyatında iz bırakan tarihi aile. Sabetayist cemaat bağlantıları araştırmacılar tarafından incelenmektedir.", members: ["Keçecizade ailesi üyeleri"] },
    { id: "gorbon", name: "Gorbon Ailesi", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sabetayist cemaat bağlantıları olan tarihi aile. Siyaset ve iş dünyasıyla da akrabalık bağları bulunmaktadır.", members: ["Gorbon ailesi üyeleri"] },

    // === SİYASET & DEVLET ===
    { id: "inonu", name: "İnönü Ailesi", category: "siyaset", origin: "Sefarad", coords: [38.4237, 27.1428], description: "Türkiye Cumhuriyeti'nin ikinci cumhurbaşkanı İsmet İnönü'nün ailesi. Evliyazadeler ile evlilik yoluyla bağlantılı.", members: ["İsmet İnönü", "Mevhibe İnönü (Evliyazade)", "Erdal İnönü"] },
    { id: "kazim_dirik", name: "Kazım Dirik", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "General ve İzmir Valisi. Tayfun Er'in 'Erguvaniler' kitabında Sabetayist bağlantıları ele alınmıştır.", members: ["Kazım Dirik"] },
    { id: "hasan_polatkan", name: "Hasan Polatkan", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Demokrat Parti dönemi Maliye Bakanı. Germirli ailesiyle olan bağlantıları araştırılmıştır.", members: ["Hasan Polatkan"] },
    { id: "nevzat_tandogan", name: "Nevzat Tandoğan", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Uzun yıllar Ankara Valiliği yapmış güçlü bürokrat. Kapancı cemaati ve Edin ailesiyle bağlantılı.", members: ["Nevzat Tandoğan"] },
    { id: "kazim_ozalp", name: "Kazım Özalp", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Milli Mücadele komutanlarından, TBMM başkanlığı yapmış siyasetçi.", members: ["Kazım Özalp"] },
    { id: "mesut_yilmaz", name: "Mesut Yılmaz", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "ANAP Genel Başkanı ve Başbakan. Keçecizadeler ve Gorbon ailesiyle olan ilişkileri araştırılmıştır.", members: ["Mesut Yılmaz"] },
    { id: "mithat_pasa", name: "Mithat Paşa", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı reformcusu ve Kanun-i Esasi'nin mimarı. Mardinizadeler ve İnegöllüzadeler ile akrabalık bağı iddia edilmektedir.", members: ["Mithat Paşa"] },

    // === İŞ DÜNYASI ===
    { id: "boyner", name: "Boyner Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türkiye'nin önde gelen perakende ve tekstil holdinglerinden Boyner Grup'un sahibi aile. İnegöllüzadeler ile bağlantılı.", members: ["Osman Boyner", "Cem Boyner", "Hasan Çolakoğlu"] },
    { id: "eczacibasi", name: "Eczacıbaşı Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "İlaç, yapı malzemeleri ve teknoloji alanında faaliyet gösteren dev holdingin sahibi aile. İnegöllüzadeler ile bağlantılı.", members: ["Nejat Eczacıbaşı", "Bülent Eczacıbaşı"] },
    { id: "koc", name: "Koç Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türkiye'nin en büyük sanayi kuruluşu Koç Holding'in kurucusu ailenin, Kadirbeyoğlu-Ataç ailesi üzerinden bağlantıları incelenmektedir.", members: ["Vehbi Koç", "Rahmi Koç", "Mustafa Koç"] },
    { id: "dedeman", name: "Dedeman Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Otelcilik ve turizm sektöründe büyük yatırımları bulunan aile. Edin ailesi ile bağlantılı.", members: ["Dedeman ailesi üyeleri"] },
    { id: "karamehmet", name: "Karamehmet Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Telekomünikasyon ve medya sektöründe büyük yatırımları olan aile. Eliyeşil ailesiyle akrabalık bağı bulunmaktadır.", members: ["Mehmet Emin Karamehmet"] },
    { id: "dinçkok", name: "Dinçkök Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Akkök Holding'in sahibi sanayi ailesi. Raif Dinçkök, birçok başka aileyle evlilik ve akrabalık bağları kurmuştur.", members: ["Raif Dinçkök", "Nilüfer Dinçkök"] },
    { id: "kadir_has", name: "Kadir Has", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Has Holding kurucusu ve hayırsever iş insanı. Kapancı cemaati, Edin ailesi ve Nemlizadeler ile bağlantılı.", members: ["Kadir Has"] },
    { id: "eliyesil", name: "Eliyeşil Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "İstanbul'un köklü iş ailelerinden. Karamehmet, Bezmen ve Pısak aileleriyle geniş bir akrabalık ağına sahip.", members: ["Eliyeşil ailesi üyeleri"] },
    { id: "bezmen", name: "Bezmen Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türkiye'nin tanınmış sanayi ailelerinden. Eliyeşil ve Karamehmet aileleriyle akrabalık bağları bulunmaktadır.", members: ["Bezmen ailesi üyeleri"] },
    { id: "edin", name: "Edin Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Kapancı cemaatine mensup iş ailesi. Birçok önde gelen poliik ve iş figürüyle bağlantılı.", members: ["Edin ailesi üyeleri"] },

    // === MEDYA & SANAT ===
    { id: "aydin_dogan", name: "Aydın Doğan", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Doğan Holding kurucusu ve Türkiye'nin en büyük medya grubunun eski sahibi. Neşet Bora ve Eşfak Aykaç ile bağlantılı.", members: ["Aydın Doğan"] },
    { id: "erol_simavi", name: "Erol Simavi", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Hürriyet gazetesinin eski sahibi. Kapancı cemaati ile bağlantılı olduğu iddia edilmektedir.", members: ["Erol Simavi"] },
    { id: "nuri_colakoglu", name: "Nuri Çolakoğlu", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Show TV kurucusu ve medya patronu. Dedeman ve Edin aileleriyle bağlantılı.", members: ["Nuri Çolakoğlu"] },
    { id: "abidin_dino", name: "Abidin Dino (Dinozadeler)", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Ünlü ressam ve sanatçı. Ailesi 'Dinozadeler' olarak bilinir. Büyükbabası Abidin Paşa, Osmanlı valisi ve devlet adamıdır. Babası Rasih Bey'in kızkardeşi Nefise hanım, Celal Nuri İleri ve Suphi Nuri İleri'nin annesidir. Ali Fuat Cebesoy'un teyzesi Leyla hanım, Nazım Hikmet ve Oktay Rıfat'ın anneannesidir - bu da Dinozadeler'i geniş bir entelektüel ağa bağlar. Ercüment Ekrem Talu (Defne Samyeli'nin büyükbabası), Osman Kavala, Mehmet Ali Aybar ve Hüsamettin Cindoruk da Dinozadeler ile akrabadır.", members: ["Abidin Dino", "Celal Nuri İleri", "Rasih Nuri İleri"] },
    { id: "nazim_hikmet", name: "Nazım Hikmet", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türk şiirinin en büyük isimlerinden. Dinozadeler yazısına göre anneannesi Leyla hanım, Ali Fuat Cebesoy'un teyzesidir. Bu bağlantı onu şair Oktay Rıfat ile de akraba yapar (ikisi de aynı soydan gelmektedir). Mehmet Ali Aybar'ın babaannesi de aynı aileden Hayriye hanımdır. Halide Edip Adıvar ve Abidin Dino ile de akrabalık bağları bulunmaktadır.", members: ["Nazım Hikmet", "Samiye Bilgişin"] },
    { id: "ferzan_ozpetek", name: "Ferzan Özpetek", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Uluslararası ün kazanmış yönetmen. Zeynep Aksu, Fethi Ahmet Paşa ve Tarık Zafer Tunaya ile bağlantıları araştırılmıştır.", members: ["Ferzan Özpetek", "Zeynep Aksu"] },
    { id: "halide_edip", name: "Halide Edip Adıvar", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Cumhuriyet döneminin önemli yazarı ve aktivisti. Sabetayist kökenli bağlantıları araştırılmıştır.", members: ["Halide Edip Adıvar"] },
    { id: "osman_hamdi", name: "Osman Hamdi Bey", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Ünlü ressam ve arkeolog, İstanbul Arkeoloji Müzesi'nin kurucusu. Hüsrev Gerede ve Selim Sarper ile akrabalık bağları bulunmaktadır.", members: ["Osman Hamdi Bey"] },
    { id: "vedat_milor", name: "Vedat Milor", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Tanınmış gastronomi yazarı ve televizyon sunucusu. Edin ailesi ve Mete Akyol ile bağlantılı.", members: ["Vedat Milor"] },
    { id: "defne_samyeli", name: "Defne Samyeli", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Ünlü TV sunucusu. Büyükbabası yazar Ercüment Ekrem Talu, Recaizade Mahmut Ekrem'in oğludur ve Dinozadeler ailesinden Feriha hanım ile evlenmiştir. Bu evlilik Defne Samyeli'yi Abidin Dino, Nazım Hikmet, Mehmet Ali Aybar gibi isimlerle akraba yapmaktadır. Gorbon ailesi ve Keçecizadeler ile de bağlantıları araştırılmıştır.", members: ["Defne Samyeli"] },

    // === AKADEMİ & DÜŞÜNCE ===
    { id: "celal_sengor", name: "Celal Şengör", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türkiye'nin en tanınmış jeologu ve bilim insanı. Tüli Kamhi ve Menteşe ailesi ile akrabalık bağları tespit edilmiştir.", members: ["Celal Şengör"] },
    { id: "bahriye_ucok", name: "Bahriye Üçok", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "İlahiyat profesörü ve suikasta kurban giden akademisyen. Sadri Maksudi Arsal ve Dinçkök ailesiyle bağlantılı.", members: ["Bahriye Üçok"] },
    { id: "husrev_gerede", name: "Hüsrev Gerede", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "Diplomat ve siyasetçi. Şakir Paşa ailesi, Vafi ailesi ve Osman Hamdi Bey ile geniş akrabalık ağı.", members: ["Hüsrev Gerede", "Adnan Berkay"] },
    { id: "tuli_kamhi", name: "Tüli Kamhi", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sabetayist araştırmalarda sık adı geçen figür. Celal Şengör, Uşaklıgil ailesi, Menteşe ailesi ile bağlantılı.", members: ["Tüli Kamhi"] },
    { id: "sakir_pasa", name: "Şakir Paşa Ailesi", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı dönemi paşa ailesi. Hüsrev Gerede, Münir Özkul ve Adalet Ağaoğlu ile bağlantılar bulunmaktadır.", members: ["Şakir Paşa", "Münir Özkul (damat)"] },
    { id: "muhtar_kent", name: "Muhtar Kent", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Coca-Cola'nın eski CEO'su, Türk iş dünyasının küresel yüzlerinden. Kazım İnanç ve Manyasizadeler ile bağlantılı.", members: ["Muhtar Kent"] },

    // === EK TARİHİ AİLELER & CEMAATLER ===
    { id: "karakas", name: "Karakaş Cemaati", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sabetay Sevi'nin ardılı Baruchya Ruso'nun takipçilerinden oluşan üçüncü büyük dönme cemaati. 'Karakaş' lakabı, Baruchya Ruso'nun kaşlarının siyahlığından gelir. Diğer iki cemaatten (Yakubi ve Kapancı) daha radikal kabul edilirler. Marc David Baer'in araştırmalarında Galip Pasiner'in bu cemaate mensup olduğu belirtilmiştir. Sadrazam İbrahim Ethem Paşa, Kadızadeler, Çürüksulular ve Leyla Gencer bu cemaatle ilişkilendirilir. Zekeriya Sertel ve Suat Hayri Ürgüplü ile de bağlantıları vardır.", members: ["Karakaşzade Rüştü Bey"] },
    { id: "capanzadeler", name: "Çapanzadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı İmparatorluğu'nda ilk özel gazete Tercüman-ı Ahval'i kuran Çapanzade Agah Efendi'nin ailesi.", members: ["Çapanzade Agah Efendi"] },
    { id: "menemencioglu", name: "Menemencioğlu Ailesi", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı bürokrasisinde önemli rol oynayan köklü aile. Koç ailesi ve Narmanlı ailesiyle bağlantılı.", members: ["Ethem Menemencioğlu", "Nermin Menemencioğlu"] },
    { id: "narmanli", name: "Narmanlı Ailesi", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "İstanbul'un tarihi Narmanlı Han'ın sahibi aile. Koç ailesi, Edin ailesi ve Menemencioğlu ailesiyle bağlantılı.", members: ["Narmanlı ailesi üyeleri"] },
    { id: "vafi", name: "Vafi Ailesi", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Hüsrev Gerede, Ali Haydar Arsebük ve Hacı Ahmed Vesim Paşa ile geniş akrabalık ağı bulunan tarihi aile.", members: ["Cemil Vafi", "Vafi ailesi üyeleri"] },
    { id: "feyzioğlu", name: "Feyzioğlu Ailesi", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "İnegöllüzadeler ve Silahçı Hasan Tahsin ile bağlantıları bulunan aile.", members: ["Feyzioğlu ailesi üyeleri"] },
    { id: "nemlizadeler", name: "Nemlizadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Kadir Has ve Can Kıraç ile bağlantıları olan tarihi aile.", members: ["Nemlizade ailesi üyeleri"] },
    { id: "koprululer", name: "Köprülü Ailesi", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı Sadrazamları çıkaran köklü aile. Talat Muşkara ile bağlantıları araştırılmıştır.", members: ["Köprülü ailesi üyeleri"] },
    { id: "aynizadeler", name: "Aynizadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Seyfullah Esin ve Münevver Ayaşlı ile bağlantıları bulunan tarihi Sabetayist aile.", members: ["Aynizade ailesi üyeleri"] },

    // === EK SİYASET & DEVLET ===
    { id: "ecevit", name: "Ecevit Ailesi", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Başbakan Bülent Ecevit ve eşi Rahşan Ecevit. Aydın Boysan, Ali Sami Yen, Hasan Rıza Soyak ile bağlantıları araştırılmıştır.", members: ["Bülent Ecevit", "Rahşan Ecevit"] },
    { id: "ismail_cem", name: "İsmail Cem", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Dışişleri Bakanı ve gazeteci. İpekçi ailesiyle akrabalık bağları bulunmaktadır.", members: ["İsmail Cem İpekçi"] },
    { id: "kemal_dervis", name: "Kemal Derviş", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Ekonomiden sorumlu Devlet Bakanı ve UNDP Başkanı. Sabetayist kökenli bağlantıları araştırılmıştır.", members: ["Kemal Derviş"] },
    { id: "suat_urguplu", name: "Suat Hayri Ürgüplü", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Başbakanlık yapmış siyasetçi. Kapancı Cemaati, Bezmenler, Celal Şengör ve Zekeriya Sertel ile bağlantılı.", members: ["Suat Hayri Ürgüplü"] },
    { id: "murat_karayalcin", name: "Murat Karayalçın", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Ankara Büyükşehir Belediye Başkanı ve SHP Genel Başkanı. Koç ailesi, Tandoğan ve Mardinizadeler ile bağlantılı.", members: ["Murat Karayalçın"] },
    { id: "turan_gunes", name: "Turan Güneş", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Dışişleri Bakanı. İsmet İnönü ve İnegöllüzadeler ile bağlantıları araştırılmıştır.", members: ["Turan Güneş"] },
    { id: "nuri_conker", name: "Nuri Conker", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Atatürk'ün Selanik'ten çocukluk arkadaşı ve milletvekili. Salih Bozok ile birlikte Sabetayist araştırmalarında adı geçer.", members: ["Nuri Conker", "Salih Bozok"] },

    // === EK İŞ DÜNYASI ===
    { id: "ipekci", name: "İpekçi Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci Abdi İpekçi'nin ailesi. Ali Sami Yen ile bağlantıları ve İsmail Cem'in akrabası.", members: ["Abdi İpekçi"] },
    { id: "kavala", name: "Kavala Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osman Kavala'nın ailesi. Koç ailesi, Menemencioğlu ailesi ve Narmanlı ailesiyle bağlantılı.", members: ["Osman Kavala", "Mehmet Kavala"] },
    { id: "sadikoglu", name: "Sadıkoğlu Ailesi", category: "is", origin: "Balkan", coords: [42.7339, 25.4858], description: "Dinozadeler yazısına göre Aslan Sadıkoğlu'nun kızı Hatice, Galatasaray başkanı Faruk Süren'in eşidir. Hatice'nin annesi şair Oktay Rıfat'ın amcasının kızıdır. Bir diğer kızı Aysel Bosna, Ömer Madra'nın kardeşlerinin annesidir. Aile, Sabancılarla birlikte Bossa markasını kuran işadamı Salih Bosna ile de akrabadır.", members: ["Aslan Sadıkoğlu", "Hatice Süren"] },
    { id: "can_kirac", name: "Can Kıraç", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Koç Holding'in efsanevi yöneticisi. Nemlizadeler, Kadir Has ve Verdi ailesiyle bağlantılı.", members: ["Can Kıraç"] },

    // === EK MEDYA & SANAT ===
    { id: "gulse_birsel", name: "Gülse Birsel", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Popüler yazar ve senarist. Haldun Dormen, Suat Hayri Ürgüplü ve Erboy ailesiyle bağlantıları araştırılmıştır.", members: ["Gülse Birsel"] },
    { id: "ertugrul_ozkök", name: "Ertuğrul Özkök", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Hürriyet gazetesi genel yayın yönetmeni. İsmail Erez ve Seccadecibaşı İzzet Bey ile bağlantılı.", members: ["Ertuğrul Özkök"] },
    { id: "orhan_pamuk", name: "Orhan Pamuk", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Nobel ödüllü yazar. Esin Eden, Mazlum İşkora ve İsmail Erez ile bağlantıları araştırılmıştır.", members: ["Orhan Pamuk"] },
    { id: "ali_sami_yen", name: "Ali Sami Yen", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Galatasaray Spor Kulübü'nün kurucusu. İpekçiler ve Yılancıoğlu ailesiyle bağlantılı.", members: ["Ali Sami Yen"] },
    { id: "haldun_dormen", name: "Haldun Dormen", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türk tiyatrosunun efsanevi ismi. Gülse Birsel, Coşkun Kırca ve Erboy ailesiyle bağlantılı.", members: ["Haldun Dormen"] },
    { id: "ayse_kulin", name: "Ayşe Kulin", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Bestseller yazar. 'Adı: Aylin' romanıyla akrabası Aylin Devrimel'in hayatını anlatmıştır. Aylin, Oklahoma'daki askeri hastanede görevliyken askerlere cesaret ilacı verildiğini raporlamış, Washington'da diplomat olmayı hedeflerken şüpheli şekilde hayatını kaybetmiştir. Suat Hayri Ürgüplü ve Neyzi ailesiyle bağlantılı olan Kulin, Kasım Gülek ve Bayındırlızadeler ile de akrabalık bağlarına sahiptir.", members: ["Ayşe Kulin", "Aylin Devrimel", "Tayibe (kızkardeş)"] },
    { id: "zekeriya_sertel", name: "Zekeriya Sertel", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci ve yazar. Kapancı Cemaati ve Karakaş Cemaati ile bağlantılı. Sabiha Sertel'in eşi.", members: ["Zekeriya Sertel", "Sabiha Sertel"] },
    { id: "manço", name: "Manço Ailesi", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Halide Edip Adıvar ve Emre Gönensay ile bağlantıları araştırılmış aile.", members: ["Manço ailesi üyeleri"] },
    { id: "sururi_cezzar", name: "Sururi & Cezzar", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türk tiyatrosunun efsane çifti Gülriz Sururi ve Engin Cezzar. Blog'da Karakaş Cemaati ile bağlantılı olarak etiketlenmiştir. Haldun Dormen çevresiyle de ilişkili.", members: ["Gülriz Sururi", "Engin Cezzar"] },
    { id: "fazil_say", name: "Fazıl Say", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Dünyaca ünlü piyanist ve besteci. Blog'da Kapancı Cemaati bağlamında etiketlenmiştir. Cemal Reşit Rey ve Osman Zeki Üngör çevresiyle ilişkilendirilir.", members: ["Fazıl Say"] },

    // === İBRANİYET AKADEMİSİ BLOG ETİKETLERİNDEN ===
    // Osmanlı Dönemi Paşaları & Devlet Adamları
    { id: "abidin_pasa", name: "Abidin Paşa", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı dönemi valisi ve devlet adamı. Dinozadeler ailesinin patriarşıdır. Oğlu Rasih Bey'in çocukları arasında ünlü ressam Abidin Dino vardır. Kızı Nefise, gazeteci Celal Nuri İleri ve Suphi Nuri İleri'nin annesidir. Kızı Sabire'nin torunu Ercüment Ekrem Talu aracılığıyla Defne Samyeli ile de soy bağı bulunur. Adana valiliği sırasında kuzeni Yusuf Dino Paşa ile birlikte Manisa'ya göç etmiştir.", members: ["Abidin Paşa", "Rasih Bey", "Nefise Hanım", "Sabire Hanım"] },
    { id: "halil_rifat_pasa", name: "Halil Rıfat Paşa", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı Sadrazamı. Sabetayist cemaat bağlantıları araştırma konusu olmuştur.", members: ["Halil Rıfat Paşa"] },
    { id: "enver_pasa", name: "Enver Paşa", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "İttihat ve Terakki Cemiyeti'nin liderlerinden ve Harbiye Nazırı. Selanik kökenli olup dönme cemaatleriyle bağlantıları araştırılmıştır. Birinci Dünya Savaşı'na girişin baş mimarlarından. Asya Türklüğü'nü birleştirme hayaliyle Orta Asya'ya geçip 1922'de hayatını kaybetti.", members: ["Enver Paşa", "Arzu Enver"] },
    { id: "ibrahim_ethem_pasa", name: "Sadrazam İbrahim Ethem Paşa", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı Sadrazamı. Sabetayist kökenli olduğu iddia edilmiştir.", members: ["İbrahim Ethem Paşa"] },
    { id: "fethi_okyar", name: "Fethi Okyar", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Serbest Cumhuriyet Fırkası kurucusu ve Başbakan. Selanik kökenli bağlantıları araştırılmıştır.", members: ["Fethi Okyar"] },
    { id: "kasim_gulek", name: "Kasım Gülek", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "CHP Genel Sekreteri. Tayyibe Gülek ile birlikte Sabetayist bağlantıları incelenmiştir.", members: ["Kasım Gülek", "Tayyibe Gülek"] },
    { id: "kenan_evren", name: "Kenan Evren", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "12 Eylül askeri darbesinin lideri ve 7. Cumhurbaşkanı. Tartışmalı köken araştırmaları yapılmıştır.", members: ["Kenan Evren"] },
    { id: "kilic_ali", name: "Kılıç Ali", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Milli Mücadele komutanı ve Atatürk'ün yakın arkadaşı. Dinozadeler yazısına göre, Kurtuluş Savaşı sonrası Suphi Nuri İleri'nin çıkardığı İleri gazetesini tabancasının kabzasıyla basarak gazeteciye zarar vermiştir. Selanik bağlantıları ve Nuri Conker ile Atatürk'ün yakın çevresi.", members: ["Kılıç Ali"] },
    { id: "hasan_esat_isik", name: "Hasan Esat Işık", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Dışişleri ve Milli Savunma Bakanı. Sabetayist bağlantıları araştırılmıştır.", members: ["Hasan Esat Işık"] },

    // Cumhuriyet Dönemi Siyasetçileri
    { id: "latife_hanim", name: "Latife Hanım", category: "siyaset", origin: "Sefarad", coords: [38.4237, 27.1428], description: "Atatürk'ün eşi (1923-1925). İzmir'in köklü Uşşakizadeler ailesine mensuptur. Uşşakizadeler, Evliyazadeler ile köklü akrabalık bağlarına sahiptir. Paris Sorbonne'ünde hukuk eğitimi almış nadir Osmanlı kadınlarındandır.", members: ["Latife Hanım"] },
    { id: "ismail_erez", name: "İsmail Erez", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Büyükelçi. Seccadecibaşı İzzet Bey, Ertuğrul Özkök ve Edin ailesiyle bağlantılı.", members: ["İsmail Erez"] },
    { id: "nazli_ilicak", name: "Nazlı Ilıcak", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci ve siyasetçi. Sabetayist bağlantıları araştırma konusu olmuştur.", members: ["Nazlı Ilıcak"] },
    { id: "hiram_abas", name: "Hiram Abas", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "MİT mensubu. Blog'da 'Müşir Ahmet Şakir Paşa - Saman Belgerden - Osman Hamdi Bey - Hiram Abas' başlıklı gönderide Şakir Paşa ailesi ve Osman Hamdi Bey ile birlikte ele alınmıştır.", members: ["Hiram Abas"] },

    // İş Dünyası
    { id: "dinc_bilgin", name: "Dinç Bilgin", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sabah gazetesi ve ATV'nin eski sahibi. Medya sektöründe önemli rol oynamıştır.", members: ["Dinç Bilgin"] },
    { id: "ercan_arikli", name: "Ercan Arıklı", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "İş insanı. Koç ailesi, Narmanlı ve Menemencioğlu ailesiyle bağlantılı.", members: ["Ercan Arıklı"] },
    { id: "jak_kamhi", name: "Jak Kamhi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Profilo Holding kurucusu. Tüli Kamhi ile akrabalık bağı.", members: ["Jak Kamhi"] },
    { id: "faruk_suren", name: "Faruk Süren", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Galatasaray başkanı ve iş insanı. Dinozadeler yazısına göre eşi Hatice, Aslan Sadıkoğlu'nun kızıdır. Hatice'nin annesi şair Oktay Rıfat'ın amcasının kızıdır. Bu bağlantı Faruk Süren'i Dinozadeler, Nazım Hikmet ve Cebesoy aileleriyle akraba yapar.", members: ["Faruk Süren"] },
    { id: "neyzi", name: "Neyzi Ailesi", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Suat Hayri Ürgüplü ve Ayşe Kulin ile bağlantılı köklü iş ailesi.", members: ["Neyzi ailesi üyeleri"] },
    { id: "burak_elmas", name: "Burak Elmas", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Galatasaray başkanı ve iş insanı.", members: ["Burak Elmas"] },

    // Medya, Sanat & Edebiyat
    { id: "abidin_daver", name: "Abidin Daver", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci ve denizcilik yazarı. Cumhuriyet dönemi basınının önemli isimlerinden. Blog'da Kapancı Cemaati ile birlikte etiketlenmiştir. Abidin Dino (Dinozadeler) ailesinin de adıyla benzerlik taşır ancak farklı kişidir.", members: ["Abidin Daver"] },
    { id: "afife_jale", name: "Afife Jale", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türkiye'nin ilk Müslüman kadın tiyatro oyuncusu. Blog'da Sabetayist toplulukla ilişkili olarak etiketlenmiştir. Selanik kökenli çevrelerle bağlantısı araştırma konusu olmuştur.", members: ["Afife Jale"] },
    { id: "ahmet_ertegun", name: "Ahmet Ertegün", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Atlantic Records kurucusu. Dünya müzik endüstrisinin en etkili isimlerinden.", members: ["Ahmet Ertegün", "Nesuhi Ertegün"] },
    { id: "ayla_algan", name: "Ayla Algan", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sinema ve tiyatro oyuncusu. İnegöllüzadeler ile bağlantılı.", members: ["Ayla Algan"] },
    { id: "ayten_alpman", name: "Ayten Alpman", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türk pop müziğinin öncülerinden şarkıcı. Blog'da 'Ahmet Ertegün - Vedat Türkali - Karakaş Cemaati' başlıklı gönderide İlham Gencer ve Nilgün Belgün ile birlikte Karakaş Cemaati bağlamında etiketlenmiştir.", members: ["Ayten Alpman"] },
    { id: "banu_alkan", name: "Banu Alkan", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sinema oyuncusu. Blog'da Kapancı Cemaati bağlamında etiketlenmiştir. Yeşilçam'ın tanınmış isimlerinden olup aile kökenleri araştırma konusu olmuştur.", members: ["Banu Alkan"] },
    { id: "cemal_resit_rey", name: "Cemal Reşit Rey", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türk klasik müziğinin kurucularından besteci ve orkestra şefi.", members: ["Cemal Reşit Rey"] },
    { id: "derya_alabora", name: "Alabora Ailesi", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Tiyatro ve sinema dünyasının tanınmış ailesi.", members: ["Derya Alabora", "Mehmet Ali Alabora", "Mustafa Alabora"] },
    { id: "duygu_asena", name: "Duygu Asena", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci ve yazar. 'Kadının Adı Yok' kitabıyla Türk feminizminin öncülerinden. Blog'da Çapanzadeler yazısında etiketlenmiş, ayrıca sabetayciavcisi blogunda 'Ressam Nihal Erem - Duygu Asena - Nihal Atsız - Ömer Üründül' başlıklı gönderide ele alınmıştır.", members: ["Duygu Asena"] },
    { id: "fatma_girik", name: "Fatma Girik", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Yeşilçam'ın efsane oyuncusu ve siyasetçi. Blog'da 'Bülbülderesi Mezarlığından Bir Portre: Yusuf Atılgan' yazısında Yusuf Atılgan ve Durul Gence ile birlikte etiketlenmiştir. Bülbülderesi Mezarlığı, Sabetayist topluluk mezarlığı olarak bilinir.", members: ["Fatma Girik"] },
    { id: "haldun_taner", name: "Haldun Taner", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türk edebiyatının önemli hikayeci ve oyun yazarı. Kabare tiyatrosunun öncüsü.", members: ["Haldun Taner"] },
    { id: "hifzi_topuz", name: "Hıfzı Topuz", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci, yazar ve diplomat. Türk basın tarihinin en kapsamlı çalışmalarını yapmıştır. Blog'da Kapancı Cemaati ile bağlantılı olarak etiketlenmiştir.", members: ["Hıfzı Topuz"] },
    { id: "hincal_uluc", name: "Hıncal Uluç", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci ve spor yazarı. Sabah gazetesinin köşe yazarı olarak tanınır. Blog'da Sabetayist bağlantıları çerçevesinde etiketlenmiştir. Dinç Bilgin'in Sabah gazetesinde uzun yıllar yazmıştır.", members: ["Hıncal Uluç"] },
    { id: "ilham_gencer", name: "İlham Gencer", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Piyanist ve besteci. Blog'da 'Ahmet Ertegün - Vedat Türkali - Karakaş Cemaati' başlıklı gönderide Ayten Alpman ve Nilgün Belgün ile birlikte Karakaş Cemaati bağlamında ele alınmıştır. Leyla Gencer ve Barış Pirhasan ile aynı yazıda etiketlenmiştir.", members: ["İlham Gencer"] },
    { id: "leyla_gencer", name: "Leyla Gencer", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Dünyaca ünlü opera sopranosu. 'La Diva Turca' lakabıyla tanınır.", members: ["Leyla Gencer"] },
    { id: "mahmut_yesari", name: "Mahmut Yesari", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Yazar ve gazeteci. Erken Cumhuriyet dönemi edebiyatının önemli ismi.", members: ["Mahmut Yesari"] },
    { id: "nilgun_belgun", name: "Nilgün Belgün", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Tiyatro ve sinema oyuncusu. Blog'da 'Ahmet Ertegün - Vedat Türkali - Karakaş Cemaati' başlıklı gönderide İlham Gencer ve Ayten Alpman ile birlikte Karakaş Cemaati bağlamında etiketlenmiştir.", members: ["Nilgün Belgün"] },
    { id: "oktay_rifat", name: "Oktay Rıfat", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Garip akımının kurucularından şair. Melih Cevdet Anday ve Orhan Veli ile birlikte Türk şiirini kökten değiştirdi. Dinozadeler yazısına göre anneannesi Leyla hanım, Ali Fuat Cebesoy'un teyzesidir - bu onu Nazım Hikmet ile de akraba yapar. Amcasının kızı, Faruk Süren'in eşi Hatice'nin annesidir.", members: ["Oktay Rıfat"] },
    { id: "sevgi_soysal", name: "Sevgi Soysal", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Yazar. 'Yenişehir'de Bir Öğle Vakti' romanıyla tanınır.", members: ["Sevgi Soysal"] },
    { id: "ugur_yucel", name: "Uğur Yücel", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sinema oyuncusu ve yönetmen. Türk sinemasının önemli isimlerinden.", members: ["Uğur Yücel"] },
    { id: "vedat_turkali", name: "Vedat Türkali", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Yazar ve senarist. Blog'da 'Ahmet Ertegün - Vedat Türkali - Karakaş Cemaati' başlıklı gönderide Karakaş Cemaati bağlamında Ahmet Ertegün, İlham Gencer, Ayten Alpman ve Nilgün Belgün ile birlikte ele alınmıştır. Zeynep Cassalini ile de aynı yazıda etiketlenmiştir.", members: ["Vedat Türkali"] },
    { id: "yahya_kemal", name: "Yahya Kemal", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türk şiirinin büyük ustası. Asıl adı Ahmed Agah. Selanik'te dönme okullarında okuduğu blog'da detaylı şekilde anlatılmaktadır. Muallim Şemsi Efendi'nin açtığı okula devam etmiş, Yakubi cemaati ile ilişkilendirilir. Paris'te uzun yıllar yaşamış, Batı şiiri ile Osmanlı geleneğini buluşturmuştur.", members: ["Yahya Kemal Beyatlı"] },
    { id: "selahattin_pinar", name: "Selahattin Pınar", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türk müziğinin büyük bestecilerinden. Sabetayist bağlantıları araştırılmıştır.", members: ["Selahattin Pınar"] },
    { id: "sahin_alpay", name: "Şahin Alpay", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci ve akademisyen. Zaman gazetesi köşe yazarı.", members: ["Şahin Alpay"] },
    { id: "sanar_yurdatapan", name: "Şanar Yurdatapan", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Besteci ve insan hakları aktivisti.", members: ["Şanar Yurdatapan"] },
    { id: "yusuf_atilgan", name: "Yusuf Atılgan", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Yazar. 'Aylak Adam' ve 'Anayurt Oteli' romanlarıyla Türk edebiyatının en özgün isimlerinden. Blog'da 'Bülbülderesi Mezarlığından Bir Portre: Yusuf Atılgan' başlıklı yazıda anlatılmış, Fatma Girik ve Durul Gence ile birlikte etiketlenmiştir. Bülbülderesi, İstanbul'daki Sabetayist mezarlığıdır.", members: ["Yusuf Atılgan"] },
    { id: "cahit_ucuk", name: "Cahit Uçuk", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Yazar. Çocuk edebiyatı ve tarihi romanlarıyla tanınır.", members: ["Cahit Uçuk"] },

    // Akademi & Düşünce
    { id: "suha_gursey", name: "Süha Gürsey", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "Dünyaca ünlü Türk fizikçi. Kuantum fiziği alanında öncü çalışmalar yapmıştır.", members: ["Süha Gürsey"] },
    { id: "talat_halman", name: "Talat Halman", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "İlk Kültür Bakanı, akademisyen ve çevirmen.", members: ["Talat Sait Halman"] },
    { id: "nur_vergin", name: "Nur Vergin", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sosyolog ve akademisyen. Boğaziçi Üniversitesi öğretim üyesi.", members: ["Nur Vergin"] },
    { id: "osman_zeki_ungor", name: "Osman Zeki Üngör", category: "akademi", origin: "Selanik", coords: [40.6401, 22.9444], description: "Cumhurbaşkanlığı Senfoni Orkestrası'nın kurucusu ve İstiklal Marşı'nın ilk şefi.", members: ["Osman Zeki Üngör"] },

    // Tarihi Aileler
    { id: "babanzadeler", name: "Babanzadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Kürt-Osmanlı kökenli köklü aile. Sabetayist bağlantıları araştırılmıştır.", members: ["Babanzade ailesi üyeleri"] },
    { id: "bayindirlizade", name: "Bayındırlızadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı dönemi köklü ailesi.", members: ["Bayındırlızade ailesi üyeleri"] },
    { id: "curuksulu", name: "Çürüksulular", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı dönemi ailesi. Sabetayist bağlantıları araştırılmıştır.", members: ["Çürüksulu ailesi üyeleri"] },
    { id: "kadizade", name: "Kadızadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Osmanlı dönemi ailesi. Sabetayist cemaat bağlantıları araştırılmıştır.", members: ["Kadızade ailesi üyeleri"] },
    { id: "kinacizade", name: "Kınacızadeler", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Kınacızade Şakir Bey'in ailesi. Sabetayist bağlantıları araştırılmıştır.", members: ["Kınacızade Şakir Bey"] },
    { id: "voskay", name: "Voskay Ailesi", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Sabetayist bağlantıları araştırılan tarihi aile.", members: ["Voskay ailesi üyeleri"] },
    { id: "semsi_efendi", name: "Muallim Şemsi Efendi", category: "tarih", origin: "Selanik", coords: [40.6401, 22.9444], description: "Atatürk'ün ilk öğretmeni. Selanik'te Yakubi cemaatinin eğitim öncüsüdür. Blog'daki 'Galip Pasiner'in gözüyle Şemsi Efendi' yazısında, Karakaş cemaatinden Korgeneral Galip Pasiner'in Şemsi Efendi'yi hocası olarak anlattığı belirtilmektedir. Modern eğitim yöntemlerini Selanik'te uygulayan ilk eğitimcilerdendir.", members: ["Şemsi Efendi", "Galip Pasiner"] },

    // === BLOG GÖNDERİLERİNDEN BULUNAN YENİ İSİMLER ===
    { id: "ali_fuat_cebesoy", name: "Ali Fuat Cebesoy", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Milli Mücadele komutanı. Teyzesi Leyla hanım, Nazım Hikmet ve Oktay Rıfat'ın anneannesidir. Diğer teyzesi Hayriye hanım, Mehmet Ali Aybar'ın babaannesidir.", members: ["Ali Fuat Cebesoy", "İsmail Fazıl Paşa"] },
    { id: "mehmet_ali_aybar", name: "Mehmet Ali Aybar", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Türkiye İşçi Partisi Genel Başkanı. Ali Fuat Cebesoy'un teyzesinin torunu. Dinozadeler ile akrabalık bağı.", members: ["Mehmet Ali Aybar"] },
    { id: "omer_madra", name: "Ömer Madra", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci ve Açık Radyo kurucusu. Sadıkoğlu ailesi ve Dinozadeler ile bağlantılı. Babası Maliye Nazırı Fuat Ağralı'nın damadı.", members: ["Ömer Madra", "Salih Madra", "Sezai Madra"] },
    { id: "ercument_talu", name: "Ercüment Ekrem Talu", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Yazar ve gazeteci. Recaizade Mahmut Ekrem'in oğlu. Dinozadeler yazısına göre, Abidin Paşa'nın kızı Sabire hanım'ın kızı Feriha hanım ile evlenmiştir. Oğlu Muvakkar Ekrem Talu'nun eşi, Mehmet Ali Aybar'ın baldızıdır. Gazeteci-yazar Umur Talu ve Defne Samyeli'nin kızlarının babası Eren Talu, bu evlilikten gelmektedir.", members: ["Ercüment Ekrem Talu", "Umur Talu", "Eren Talu"] },
    { id: "cindoruk", name: "Hüsamettin Cindoruk", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "TBMM Başkanı ve DYP Genel Başkanı. Kayınvalidesi, Hasan Polatkan'ın baldızıdır. Ali Refik İleri ile akraba.", members: ["Hüsamettin Cindoruk"] },
    { id: "kazim_taskent", name: "Kazım Taşkent", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Yapı Kredi Bankası'nın 1944'te kurucusu. Çanakkale Savaşı'nın önemli komutanlarından Esat Bülkat Paşa'nın yeğenidir. Dinozadeler yazısına göre teyzesinin kızı Kudret hanım, Prof. Celal Şengör'ün anneannesidir - bu bağlantı Taşkent'i akademi dünyasıyla da ilişkilendirir.", members: ["Kazım Taşkent"] },
    { id: "galip_pasiner", name: "Galip Pasiner", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Korgeneral. Akademisyen Marc David Baer'in Karakaş Cemaatinden olduğunu yazdığı isim. Blog'daki yazıya göre, hocası Muallim Şemsi Efendi'yi anlatan görgü tanığı olarak kayda geçirilmiştir. Oğlu Orhan Pasiner'in oğlu Ali Pasiner, Leyla İpekçi Kaplanoğlu'nun teyzesinin eşidir. Ali Pasiner'in ilk eşi Figen Mirel, daha sonra Kapancı Cemaatinden işadamı Halil Bezmen ile evlenmiştir.", members: ["Galip Pasiner", "Orhan Pasiner", "Ali Pasiner"] },
    { id: "suphi_nuri_ileri", name: "Suphi Nuri İleri", category: "medya", origin: "Selanik", coords: [40.6401, 22.9444], description: "Gazeteci, yazar ve avukat. Ağabeyi Celal Nuri İleri'nin Malta'ya sürülmesinin ardından Ati-İleri gazetesinin başına geçmiş, Atatürk de takma isimlerle bu gazetede yazılar yayınlamıştır. Türkiye Sosyalist Partisi Genel Sekreterliği de yapmıştır. Abidin Dino'nun ablası Leyla Hanım ile evlenmiştir. Şeyh Said İsyanı'nı dolaylı teşvik ettiği gerekçesiyle İstiklal Mahkemesi'nde yargılanmış ancak beraat etmiştir. Kılıç Ali tarafından gazetesi basılmış ve yaralanmıştır.", members: ["Suphi Nuri İleri", "Rasih Nuri İleri"] },
    { id: "esat_bulkat", name: "Esat Bülkat Paşa", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Çanakkale Savaşı'nın önemli komutanlarından. Dinozadeler ile akraba. Yeğeni Kazım Taşkent.", members: ["Esat Bülkat Paşa"] },
    { id: "salih_bozok", name: "Salih Bozok", category: "siyaset", origin: "Selanik", coords: [40.6401, 22.9444], description: "Atatürk'ün Selanik'ten en yakın arkadaşı ve yaveri. Sabetayist bağlantıları araştırılmıştır.", members: ["Salih Bozok", "Sedef Bozok"] },
    { id: "halil_bezmen", name: "Halil Bezmen", category: "is", origin: "Selanik", coords: [40.6401, 22.9444], description: "Kapancı Cemaatinden işadamı. Ali Pasiner'in eski eşi Figen Mirel ile evlenmiştir. Bezmenler ile bağlantılı.", members: ["Halil Bezmen"] }
];
